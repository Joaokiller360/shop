        ...
        coreComponents={[
          {
            component: {
              default: (
                <div className="product__single__price text-2xl text-center font-bold">
                  {price.regular.text}
                </div>
              )
            },
                  ...
                  {(state: AddToCartState, actions: AddToCartActions) => (
                    <div className="mt-6 space-y-3">
                      {state.isInStock === true && (
                        <>
                          ...
                          <Button
                            ...
                            className="w-full py-6 rounded-2xl cursor-pointer"
                      ...
                      {state.isInStock === false && (
                        <Button
                          onClick={() => {}}
                          className="w-full py-6 cursor-pointer rounded-2xl"
                          disabled
                        >
                          {_('SOLD OUT')}
                        </Button>
