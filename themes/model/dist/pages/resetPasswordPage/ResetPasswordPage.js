...
function Success({ children }) {
    return /*#__PURE__*/ React.createElement("div", {
        ...
        title: _('Volver Al Inicio'),
        type: "button",
        className: "cursor-pointer w-full mt-5 rounded-2xl",
        onClick: ()=>{
...
function ResetForm({ action }) {
    ...
    return success ? /*#__PURE__*/ React.createElement(Success, null, /*#__PURE__*/ React.createElement("p", {
        style: {
            whiteSpace: "pre-line"
        }
    }, _("reset_password_email"))) : /*#__PURE__*/ React.createElement(ResetPasswordForm, {
